...
Kaiko provides live and historical institutional quality market data for the digital assets. Our serice retrieves and validates millions of trades each day from the world's leading cryptocurrency exchanges to deliver robust and reliable market data to financial institutions globally.
...
```json
{
	...
	"next_url": "https://query-api.kaiko.io/bfnx/spot/btc-usd/trades/?continuation_token=ab25lIG1vcmUgYmVlciBpcyBvbmUgbW9yZSBiZWVyIHRvbyBtYW55"
}
...
```curl
curl "https://query-api.kaiko.io/v1/data/trades.v1/exchanges/bfnx/spot/btc-usd/trades"
	-H "x-api-key: <client-api-key>"
```
...
`GET https://query-api.kaiko.io/v1/data/trades.v{trades_version}/exchanges/{exchange}/{instrument_class}/{instrument}/trades{?start_time,end_time,page_size,continuation_token}`
...
`instrument_class` | Yes | Instrument `code`. See [/v1/instruments](#exchange-instruments).
`instrument` | Yes | Instrument `code`. See [/v1/instruments](#exchange-instruments).
...
```curl
curl "https://query-api.kaiko.io/v1/data/trades.v1/exchanges/gdax/spot/btc-usd/trades/recent"
	-H "x-api-key: <client-api-key>"
```
...
`GET https://query-api.kaiko.io/v1/data/trades.v{trades_version}/exchanges/{exchange}/{instrument_class}/{instrument}/trades/recent{?limit}`
...
```curl
curl "https://query-api.kaiko.io/v1/data/trades.v1/exchanges/gdax/spot/btc-usd/aggregations/ohlcv"
	-H "x-api-key: <client-api-key>"
```
...
`GET https://query-api.kaiko.io/v1/data/trades.v{trades_version}/exchanges/{exchange}/{instrument_class}/{instrument}/aggregations/{aggregation_type}{?interval,start_time,end_time,page_size,continuation_token}`
