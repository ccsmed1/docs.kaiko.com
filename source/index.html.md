...
```curl
curl "https://query-api.kaiko.io/v1/exchanges/bfnx/spot/btc-usd/trades"
	-H "x-api-key: <client-api-key>"
```
...
`GET https://query-api.kaiko.io/v1/exchanges/{exchange}/{instrument_class}/{instrument}/trades{?start_time,end_time,page_size,continuation_token}`
...
```curl
curl "https://query-api.kaiko.io/v1/exchanges/gdax/spot/btc-usd/trades/recent"
	-H "x-api-key: <client-api-key>"
```
...
`GET https://query-api.kaiko.io/v1/exchanges/{exchange}/{instrument_class}/{instrument}/trades/recent{?limit}`
...
```curl
curl "https://query-api.kaiko.io/v1/exchanges/gdax/spot/btc-usd/aggregations/ohlcv"
	-H "x-api-key: <client-api-key>"
```
...
`GET https://query-api.kaiko.io/v1/exchanges/{exchange}/{instrument_class}/{instrument}/aggregations/{aggregation_type}{?interval,start_time,end_time,page_size,continuation_token}`
